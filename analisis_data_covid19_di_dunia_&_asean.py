...
Original file is located at
    https://colab.research.google.com/drive/1Ml945fr4bdIsrUFy3zMXooKHkJ2OhXNl
"""
...
#menghapus nilai baris yang mengandung NA
df_covid_worldwide.dropna(inplace=True)

print("\nJumlah missing value tiap kolom setelah didrop:")
print(df_covid_worldwide.isna().sum())

#dataset mengenai ID dari masing-masing negara
countries_url = "https://dqlab.id/data/country_details.json"
df_countries = pd.read_json(countries_url)
print(df_countries.head())

#melakukan merge dari 2 dataset yaitu df_covid_worldwide dan df_countries 
df_covid_denormalized = pd.merge(df_covid_worldwide.reset_index(),df_countries,on="geo_id").set_index("date")
print(df_covid_denormalized.head())

#mmebuat kolom baru "fatality_ratio" yang membagi kolom "deaths"  dan "confirmed_cases" dari df_covid_denormalized
df_covid_denormalized["fatality_ratio"] = df_covid_denormalized["deaths"]/df_covid_denormalized["confirmed_cases"]
print(df_covid_denormalized.head())

#mengetahui top 20 negara dengan fatality tertinggi
...
#ingin mengatahui penyebaran covid19 di bulan agustus di suluruh dunia
...
#20 negara dengan fatality tertinggi di dunia
...
#melakukan visualisasi dengan bar chart horizontal
